...
class acf_field_section_styles extends acf_field {
	...
	*/
	...
	function format_value( $value, $post_id, $field ) {
		...
		$value['padding'] = $value['padding_top'] . ' ' . $value['padding_right'] . ' ' . $value['padding_bottom'] . ' ' . $value['padding_left'];
		$value['margin'] = $value['margin_top'] . ' ' . $value['margin_right'] . ' ' . $value['margin_bottom'] . ' ' . $value['margin_left'];
		$value['border_width'] = $value['border_top'] . ' ' . $value['border_right'] . ' ' . $value['border_bottom'] . ' ' . $value['border_left'];
